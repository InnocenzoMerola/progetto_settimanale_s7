...
<h1 class="text-center">Tutti i corsi</h1>
    ...
    {{-- @session('crataed_success')
    <div class="alert alert-success" role="alert">
        Corso "{{session('created_success')->courses->activity->name}}" aggiunto con successo!
    </div>
    @endsession --}}
...
@if ($courses->count())
    ...
    {{$courses->links()}}
    @else
    <h2 class="text-center">Nessun corso disponibile</h2>
    @endif
@endsection